...
<div class="slider">
    <ul>
        <br>
        <li><img src="../../assets/imgs/img/trato.jpg" style="height: 60%" >
    ...
    <p style="color: white;" >Te Esperamos Con los Brazos Abiertos</p></li></CENTER> 
        ...
        <li><img src="../../assets/imgs/img/mano.jpg" alt="" style="height: 60%" > 
    ...
    <p style="color: white;" > Se busca desarrollar el ámbito de cooperación conjunta con reconocidas instituciones</p><p style="color: white;" > extranjeras mediante la suscripción de convenios encaminados al intercambio de la comunidad universitaria en general.</p></li></CENTER> 
        ...
        <li><img src="../../assets/imgs/img/equipo.jpg" alt="" style="height: 60%">
